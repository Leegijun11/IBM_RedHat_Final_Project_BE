...
class LLMDiary:
    ...
    async def ai_llm_story_model_run(self, input: str, config: dict) -> str:
        ...
        prompt = ChatPromptTemplate.from_template("""
                                                ...
                                                2. 아기 특유의 귀여운 어조를 살리기 위해 귀여운 유아어 어미를 자연스럽게 섞어서 사용하고 5세 이하의 아이의 어학수준의 단어만 사용합니다.
                                                3. 엄마의 속마음을 추측하는 표현은 모두 제외하고, 아이가 직접 눈으로 본 엄마의 표정과 행동만 단순하게 씁니다.
                                                4. 문장은 아기 눈높이에 맞게 아주 짧고 직관적으로 끊어서 작성합니다. (예시: ~했어요. 그리고 ~했다요.)
                                                5. 문장마다 아기의 소리와 행동을 보여주는 실제 의성어와 의태어를 알맞게 넣어줍니다.
                                                6. 엄마의 말을 전할 때는 큰따옴표를 사용하여 "엄마가 '재미있어?' 했어요"처럼 아기가 기억하기 쉬운 아주 짧고 단순한 대사로만 표현합니다.
                                                7. 4-5줄 정도의 양으로 작성하라.
                                                ...
                                                출력 일기: 
                                                  오늘 아침에 눈뜨자마자 기분이 너무 좋아서 엄마한테 방긋방긋 미소 지었어요! 
                                                  점심 맘마가 정말 맛있어서 전부 다 먹고 더 달라고 졸랐답니다. 
                                                  낮에는 침대에 누웠는데도 눈이 초롱초롱했어요. 그런데 유모차를 타자마자 나도 모르게 쿨쿨 잠들었지요! 
                                                  땀을 뻘뻘 흘리면서 개운하게 자고 일어나니까 이마도 뽀송뽀송하고 건강하대요! 
                                                ...
                                                출력 일기: 
                                                  ...
                                                  졸린데 눈은 자꾸 떠지고 마음대로 안 돼서 오후 내내 엄마한테 징징거리며 투정을 부렸답니다. 
                                                  그래도 저녁 우유는 꿀맛이라 단숨에 먹었어요. 그리고 눈을 뜨니까 폭신한 침대였지요! 
                                                  묵직한 소변 기저귀를 뽀송하게 갈아입고 체온을 재니까 정상이래요! 
                                                ...
                                                출력 일기: 
                                                  오늘 날씨가 반짝반짝해서 아빠가 유모차를 태워주고 밖으로 슝 나갔어요! 
                                                  초록 나무랑 지나가는 사람들을 두리번두리번 구경하다가 나도 모르게 스르륵 잠들었답니다. 
                                                  집에 와서 시원하게 응가를 뿡 싸서 기분이 날아갈 것 같았어요! 이마도 안 뜨겁고 완전 건강하대요! 
                                                  내일도 아빠랑 같이 놀면 좋겠어요.
